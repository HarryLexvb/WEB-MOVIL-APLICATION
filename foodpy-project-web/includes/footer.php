...
<h3>Tienda Virtual FOODPY</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Esta es una tienda virtual creada por estudiantes de Ciencias de la Computacion</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+51) 925194563<br>(+51) 999999999</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">foodpy@gmail.com</a></span>
                </div>
            </li>
