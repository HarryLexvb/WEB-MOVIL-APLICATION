...
<div class="control-group">
<label class="control-label" for="basicinput">Nombre del plato</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Origen del producto</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Platos sin descuento</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Ingrese precio del producto" value="<?php echo htmlentities($row['productPriceBeforeDiscount']);?>"  class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Precio de venta del platillo</label>
<div class="controls">
<input type="text"    name="productprice"  placeholder="Ingrese precio de venta del producto" value="<?php echo htmlentities($row['productPrice']);?>" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Descripción del Plato</label>
<div class="controls">
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Ingresa costo de envio del producto" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>
