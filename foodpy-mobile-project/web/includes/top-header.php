...
<!--este archivo es unicamente del head de botones de lista de deseos, iniciarsesion o no , seguimiendo del pedido -->
<?php 

// lo que se muestra cuando ya entro un usuario
					//muestar icono pequeño en el head con bienvenido'nombre del usuario
					//ya no muestar el iniciarsesion
	...
	<div class="container">
		<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-3 logo-holder" >
					<div class="logo">
						<a href="index.php">
							<img src="assets/images/sliders/foodpy.logo.01.png" width="265" height="75" alt="" >
						</a>
					</div>	
...
<!-- ============================================================= SHOPPING CART DROPDOWN ============================================================= -->
			...
			?>
				...
				<?php } 
				//caso que el carrito de compras este vacio
				else { ?>
					...
					<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
						<div class="items-cart-inner">
							<div class="total-price-basket">
								<span class="lbl">carrito -</span>
								<span class="total-price">
									<span class="sign">$.</span> <!--PRECIO XD -->
