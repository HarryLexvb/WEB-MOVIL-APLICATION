							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="https://www.youtube.com"></a></li>
						                <li><a class="fa fa-twitter" href="https://www.youtube.com"></a></li>
						                <li><a class="fa fa-linkedin" href="https://www.youtube.com"></a></li>
						                <li><a class="fa fa-rss" href="https://www.youtube.com"></a></li>
						                <li><a class="fa fa-pinterest" href="https://www.youtube.com"></a></li>
						            </ul><!-- /.social-icons -->
						        </div>
							</div>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Calificaciones de los Clientes</h4>
...
?>
										...
										<div class="product-add-review">
											<h4 class="title">Dejanos tu calificación por favor</h4>
