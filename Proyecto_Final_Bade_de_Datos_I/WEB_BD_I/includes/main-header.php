...
<div class="logo">
	<a href="index.php">
		...
		<!--<h2>Tienda Virtual de comida internacional</h2>-->
...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="¿Qué desea bucar?" name="product" required="required" />
		...
		<ul class="dropdown-menu">
			...
			<li>
				<div class="cart-item product-summary">
					<div class="row">
						<div class="col-xs-12">
							Su carrito de compras está vacio.
						</div>
