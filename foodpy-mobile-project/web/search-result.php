							...
							<div class="category-product  inner-top-vs">
								<div class="row">									
									...
									<div class="col-sm-6 col-md-4 wow fadeInUp">
										<div class="products">				
											<div class="product">		
												<div class="product-image">
													<div class="image">
														<a href="product-details.php?pid=<?php echo htmlentities($row['id']);?>"><img  src="assets/images/blank.gif" data-echo="img/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" alt="" width="200" height="300"></a>
													</div><!-- /muestra imagen del productoo -->		                      		   
												</div><!-- /.product-image -->
	  								...
	  								<?php } } else {?>
									<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>No se encontraron productos</h3></div>
									<?php } ?>	
