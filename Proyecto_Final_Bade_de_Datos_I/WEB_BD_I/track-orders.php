	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Seguimiento de pedido</li>
			</ul>
...
<div class="body-content outer-top-bd">
	<div class="container">
		<div class="track-order-page inner-bottom-sm">
			<div class="row">
				<div class="col-md-12">
	<h2>Seguimiento de su pedido</h2>
	<span class="title-tag inner-top-vs">
Ingrese su código/número de pedido y presione ENTER. Se le envío en su recibo y en el correo electrónico de confirmación que debería haber recibido. </span>
